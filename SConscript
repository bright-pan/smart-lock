...
src_drv = ['rtc.c', 'usart.c', 'gpio.c', 'gpio_pin.c', 'gpio_exti.c', 'gpio_pwm.c', 'gpio_adc.c', 'alarm.c', 'sms.c', 'gprs.c', 'local.c', 'gsm_usart.c', 'rfid_uart.c', 'camera_uart.c', 'untils.c', 'gsm.c', 'mms.c', 'battery.c', 'sst25v16.c', 'spibus.c', 'testprintf.c', 'des.c', 'photo.c', 'voiceapp.c', 'aip.c', 'SPI_Flash.c', 'file_update.c']
